...
{
    //[SerializeField] public Transform posTarget;
    [SerializeField] public Vector3 posTargetPos;
    ...
    {
        if (isImmediateMove) transform.position = posTargetPos;
        else transform.position = Vector3.Lerp(transform.position, posTargetPos, followMoveSpeed);
